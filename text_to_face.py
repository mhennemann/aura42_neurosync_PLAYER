...
use_elevenlabs = True  # ElevenLabs or Local TTS - if using elevenlabs then use_combined_endpoint must be false and you must use https://github.com/AnimaVR/NeuroSync_Local_API for the blendshapes
use_combined_endpoint = True  # Only set this true if you have the combined realtime API with TTS + blendshape in one call https://github.com/AnimaVR/NeuroSync_Real-Time_API
